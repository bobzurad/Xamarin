...
namespace TipCalculator
{
	public partial class StandardTipPage : ContentPage
	{
		...
		{
			Application.Current.Resources["fgColor"] = Color.FromHex("#606060");
			Application.Current.Resources["bgColor"] = Color.FromHex("#C0C0C0");
		}

		void OnDark(object sender, EventArgs e)
		{
			Application.Current.Resources["bgColor"] = Color.FromHex("#606060");
			Application.Current.Resources["fgColor"] = Color.FromHex("#C0C0C0");
		}
